...
```{r}
#| label: retail_price_plot
#| fig-cap: Gasoline retail price (weekly)
#| fig-width: 6
#| fig-asp: 0.618
...
```{r}
#| label: margin_plot_weekly
#| fig-cap: Margin (weekly)
#| fig-width: 6
#| fig-asp: 0.618
