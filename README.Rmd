...
Wholesale prices follow Dubai crude oil prices of one month ago. Correlations are `r cor(dub_import_wholesale$dub_oil_price, dub_import_wholesale$wholesale_price) %>% round(4)` if 0 month lag from Dubai to wholesalers, `r cor(dub_import_wholesale$dub_oil_price[-251], dub_import_wholesale$wholesale_price[-1]) %>% round(4)` if 1 month lag, and `r cor(dub_import_wholesale$dub_oil_price[c(-250, -251)], dub_import_wholesale$wholesale_price[c(-1, -2)]) %>% round(4)` if 2 months lag.
